package com.example.magicenglish.grammar_trainer.presentation.nouns_test.utils

import com.example.magicenglish.test.TestQuestion


object NounsTestQuestion {
    val testQuestion = listOf(
